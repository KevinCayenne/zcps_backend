...
class CertificateApplicationCreateSerializer(serializers.Serializer):
    ...
    user_id = serializers.IntegerField(required=True, help_text="用戶 ID（會員 ID）")
    clinic_id = serializers.IntegerField(required=True, help_text="診所 ID")
...
class CertificateVerificationSerializer(serializers.Serializer):
    ...
    token = serializers.CharField(required=True, help_text="驗證 token")
...
class DoctorSerializer(serializers.ModelSerializer):
    ...
    clinic_id = serializers.IntegerField(
        write_only=True, required=False, help_text="診所 ID"
    )
    user_id = serializers.IntegerField(
        write_only=True, required=False, allow_null=True, help_text="用戶 ID（可選）"
    )
    user_email = serializers.EmailField(source="user.email", read_only=True)
    user_username = serializers.CharField(source="user.username", read_only=True)
...
class ClinicUserPermissionSerializer(serializers.ModelSerializer):
    ...
    user_id = serializers.IntegerField(
        write_only=True, required=False, help_text="用戶 ID"
    )
    user_email = serializers.EmailField(source="user.email", read_only=True)
    user_username = serializers.CharField(source="user.username", read_only=True)
