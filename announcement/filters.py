...
class AnnouncementFilterSet(django_filters.FilterSet):
    ...
    active_start_time__gte = django_filters.DateTimeFilter(field_name='active_start_time', lookup_expr='gte')
    active_start_time__lte = django_filters.DateTimeFilter(field_name='active_start_time', lookup_expr='lte')
    
    active_end_time = django_filters.DateTimeFilter()
    active_end_time__gte = django_filters.DateTimeFilter(field_name='active_end_time', lookup_expr='gte')
    active_end_time__lte = django_filters.DateTimeFilter(field_name='active_end_time', lookup_expr='lte')
