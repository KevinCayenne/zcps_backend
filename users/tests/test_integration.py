...
class TestCompleteAuthenticationWorkflow:
    ...
    def test_complete_registration_login_profile_update_logout_workflow(self, api_client):
    ...
    def test_registration_with_invalid_email_format_returns_validation_error(self, api_client):
    ...
    def test_profile_update_with_duplicate_email_returns_validation_error(self, api_client):
    ...
    def test_token_verification_endpoint_with_valid_and_invalid_tokens(self, api_client):
        ...
        invalid_verify_response = api_client.post('/auth/jwt/verify/', invalid_verify_data)
        assert invalid_verify_response.status_code == status.HTTP_401_UNAUTHORIZED

    def test_dual_identifier_login_same_user_can_login_with_email_or_username(self, api_client):
        ...
        username_login_response = api_client.post('/auth/jwt/create/', username_login_data)
