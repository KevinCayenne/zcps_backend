...
class TestUserRegistrationEndpoint:
    ...
    def test_registration_with_duplicate_email_returns_400(self, api_client, create_user):
...
class TestLoginEndpoint:
    ...
    def test_login_with_email_returns_tokens(self, api_client, create_user):
        ...
        user = create_user(email='user@example.com', username='testuser', password='testpass123')
    ...
    def test_login_with_invalid_credentials_returns_401(self, api_client, create_user):
        ...
        create_user(email='user@example.com', username='testuser', password='testpass123')
        data = {
...
class TestProfileEndpoint:
    ...
    def test_profile_retrieval_with_valid_token_returns_user_data(self, api_client, create_user):
...
class TestTokenRefreshEndpoint:
    ...
    def test_token_refresh_with_valid_refresh_token_returns_new_access_token(self, api_client, create_user):
