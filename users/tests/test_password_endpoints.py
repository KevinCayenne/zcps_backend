...
class TestPasswordResetEndpoints:
    ...
    def test_reset_password_accepts_email_and_returns_204(
...
class TestPasswordChangeEndpoint:
    ...
    def test_set_password_rejects_incorrect_current_password(
        self, api_client, create_user
    ):
    ...
    def test_set_password_updates_password_with_correct_current_password(
        self, api_client, create_user
    ):
...
class TestPasswordValidation:
    ...
    def test_password_reset_with_weak_password_returns_validation_error(
        self, api_client, create_user
    ):
    ...
    def test_password_change_with_numeric_only_password_returns_error(
        self, api_client, create_user
    ):
    ...
    def test_password_change_with_common_password_returns_error(
        self, api_client, create_user
    ):
...
class TestErrorResponseFormat:
    ...
    def test_invalid_current_password_returns_400_with_error_details(
        self, api_client, create_user
    ):
