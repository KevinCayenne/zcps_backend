...
class TestTwoFactorSetupWithSettings:
    ...
    def test_complete_2fa_setup_workflow_uses_settings_config(self, api_client, user_without_2fa):
...
class TestTwoFactorLoginWithSettings:
    ...
    def test_temporary_token_lifetime_uses_settings_value(self, api_client, user_with_2fa):
...
class TestMiddlewareWithSettings:
    ...
    def test_middleware_uses_settings_for_enforcement(self, api_client, user_without_2fa):
    ...
    def test_temporary_token_restriction_middleware_allows_2fa_endpoints(self, api_client, user_with_2fa):
