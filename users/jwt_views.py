    ...
    @extend_schema(
        ...
        **Example Workflow (2FA Enforcement but User Hasn't Enabled 2FA):**
        ...
        examples=[
            ...
            OpenApiExample(
                ...
                value={
                    ...
                    "requires_2fa": True,
                    "message": (
                        "Verification code sent to your email. Please verify to complete login."
                    ),
            ...
            OpenApiExample(
                ...
                value={
                    ...
                    "message": (
                        "Two-factor authentication is required. Use this token to set up 2FA "
                        "at /auth/2fa/enable/"
                    ),
                    "allowed_endpoints": [
                        "/auth/2fa/enable/",
        ...
        responses={
            200: OpenApiResponse(
                description=(
                    "Login successful. Returns JWT tokens, temporary token, or setup token based on 2FA status."
                ),
                response=inline_serializer(
                    ...
                    fields={
                        ...
                        "temp_token": serializers.CharField(
                            help_text="Temporary 2FA token (only if user has 2FA enabled)"
                        ),
                        "setup_token": serializers.CharField(
                            help_text="Setup token (only if 2FA enforcement requires setup)"
                        ),
                        "requires_2fa": serializers.BooleanField(
                            help_text="Whether 2FA verification is required"
                        ),
                        "requires_2fa_setup": serializers.BooleanField(
                            help_text="Whether user needs to setup 2FA first"
                        ),
                        "message": serializers.CharField(help_text="Status message"),
                        "expires_at": serializers.DateTimeField(
                            help_text="When the 2FA code expires"
                        ),
                        "allowed_endpoints": serializers.ListField(
                            help_text="Endpoints allowed with setup token"
                        ),
                    },
                ),
            ),
                ...
                response=inline_serializer(
                    ...
                    fields={
                        "error": serializers.CharField(
                            help_text='Error message: "Invalid credentials."'
                        )
                    },
                ),
            ),
            403: OpenApiResponse(
                ...
                response=inline_serializer(
                    ...
                    fields={
                        "error": serializers.CharField(
                            help_text="Error message explaining 2FA is required"
                        ),
                        "required_action": serializers.CharField(
                            help_text='Action required: "enable_2fa"'
                        ),
                    },
                ),
            ),
            ...
            return Response(
                {
                    ...
                    "requires_2fa_setup": True,
                    "message": (
                        "Two-factor authentication is required. Use this token to set up 2FA at /auth/2fa/enable/"
                    ),
                    "allowed_endpoints": [
                        "/auth/2fa/enable/",
                        "/auth/2fa/enable/verify/",
    ...
    @extend_schema(
        ...
        **Security:**
        ...
        request=inline_serializer(
            ...
            fields={
                "refresh": serializers.CharField(
                    required=True, help_text="Your refresh token from login"
                )
            },
        ),
        examples=[
        ...
        responses={
            200: OpenApiResponse(
                ...
                response=inline_serializer(
                    ...
                    fields={
                        "access": serializers.CharField(
                            help_text="New JWT access token (expires in 15 min)"
                        )
                    },
                ),
            ),
                ...
                response=inline_serializer(
                    ...
                    fields={
                        ...
                        "code": serializers.CharField(
                            help_text='Error code: "token_not_valid"'
                        ),
                    },
                ),
            ),
