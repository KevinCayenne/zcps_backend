...
def create_initial_settings(apps, schema_editor):
    ...
    TwoFactorSettings.objects.create(
        ...
        temporary_token_lifetime_minutes=getattr(settings, 'TWOFACTOR_TEMPORARY_TOKEN_LIFETIME', 10),
    )
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enforce_2fa_for_all_users', models.BooleanField(default=False, help_text='When enabled, all users must enable 2FA to access the system')),
                ('default_2fa_method', models.CharField(choices=[('EMAIL', 'Email'), ('PHONE', 'Phone (coming soon)')], default='EMAIL', help_text='Default 2FA method for users who have not set a preference', max_length=20)),
                ('code_expiration_seconds', models.PositiveIntegerField(default=600, help_text='Number of seconds before a 2FA code expires (default: 600 = 10 minutes)')),
                ('max_failed_attempts', models.PositiveIntegerField(default=5, help_text='Maximum number of failed verification attempts before code is locked')),
                ('temporary_token_lifetime_minutes', models.PositiveIntegerField(default=10, help_text='Lifetime of temporary 2FA tokens in minutes (used during login flow)')),
            ],
            options={
